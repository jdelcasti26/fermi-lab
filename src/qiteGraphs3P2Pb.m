function qiteGraphs(stuMTQ3P, stuQ3P, stuMTQ2P, stuQ2P, xAxis, yAxis)
    ...
    hQ2P = plot(axisDataQ2P(s).X, axisDataQ2P(s).Y, '-', 'Color', palette(6,:), 'LineWidth', 1.8, 'Marker','s');
    hMTQ2P = plot(axisDataMTQ2P(s).X, axisDataMTQ2P(s).Y, '-', 'Color', palette(3,:),'LineWidth', 1.8, 'Marker','s');
    ...
    legend([hQ2P, hMTQ2P, hQ3P, hMTQ3P], {"smQITE", "ACQ", "QITE", "MT-QITE"});
    xl.FontSize = 22;
    yl.FontSize = 22;
    lgd.FontSize = 22;
    ax = gca;
