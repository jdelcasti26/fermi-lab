% Heatmap Ising model 6 qubits. Reported data
clear;
tic;

% Graph parameters
Field = 'Transverse field h/J';
Depth = 'Trotter step';
Heat = 'Infidelity per measurement';

outputFile = "heatmapIsing.mat";

% Model parameters
% Ising model
modelParams = [(1/2^5), (1/2^5)*2, (1/2^5)*2^2, (1/2^5)*2^3, (1/2^5)*2^4, (1/2^5)*2^5, (1/2^5)*2^6, (1/2^5)*2^7];
...
partition = {[1,2,3,7,8,9], [4,5,6,10,11,12]}; % Ising (symmetric)
permutation = [1, 2];
